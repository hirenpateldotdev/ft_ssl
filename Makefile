...
SOURCES += encryption/DES/des.c encryption/DES/des_encrypt.c encryption/DES/des_decrypt.c encryption/DES/permutate.c encryption/DES/key.c encryption/DES/processes.c
SOURCES += parse/message_digest_parse.c parse/encoding_parse.c parse/encryption_parse.c parse/helper_parse.c parse/pass.c
